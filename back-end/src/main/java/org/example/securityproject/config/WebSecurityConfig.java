...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(HttpMethod.POST,"/api/auth/login").permitAll()		// /auth/**
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        ...
        .antMatchers("/actuator/**")// Dodajte putanju /actuator/**
                ...
                .antMatchers(HttpMethod.POST, "/api/users/editUserRole") 
                .antMatchers(HttpMethod.POST, "/api/users/editUserPermission")
